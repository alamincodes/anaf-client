          ...
          <div className="relative transform overflow-hidden rounded bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
            <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
              <div className="flex justify-center items-center flex-col">
                ...
                <h2 className="font-normal text-2xl">Check your email</h2>
                <h2 className="font-normal bg-red-50 p-2 mt-3">
                  If you don't get the password reset email, please check your
                  spam folder.
                </h2>
              </div>
            </div>
