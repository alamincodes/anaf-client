          ...
          <div className="flex justify-between items-center">
            ...
            <ul className="md:flex hidden items-center space-x-8 font-semibold">
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? "border-b-4 border-dotted border-gray-600"
                    : undefined
                }
              >
                ...
                <li className="cursor-pointer relative">
                  {user?.email && (
                    <img
                      ...
                      src={
                        isLoading
                          ? "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTNzXYh-X4wxX1jfbPywa8HWoNGDnx1Tlo0-g&usqp=CAU"
                          : userData.profileImg
                      }
                      className="w-9 h-9 object-fill rounded-full ring-4 ring-black p-[1px]"
                      alt=""
                    />
                  )}
          ...
          {!user?.email && (
            <>
              ...
              <Link onClick={() => setOpen(false)} to="/signUp">
                <li className="bg-white text-black font-bold p-2 px-4">
                  Sign up
                </li>
              </Link>
            </>
